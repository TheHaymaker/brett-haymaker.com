jQuery(document).ready(function(){
  ...
  $('.submit-password-button').on("click", function(e){
    ...
    if (attemptedPassword === password) {
      ...
      $('.password-success-message').html('<p>No dice, my friend. If you really want to see my work, send me a note from my contact section for the password.</p>');
      setTimeout(function(){
  ...
  $('.submit-button').on("click", function(e){
    ...
    if( (email == "" || res == null) && (firstname == "") && (lastname == "")  ) {
      $('.success-message').html("<p>please enter your first and last name, as well as a valid email address</p>");
    } else if( (email == "" || res == null) && (firstname == "") ) {
      $('.success-message').html("<p>please enter your first name and a valid email address</p>");
    } else if( (email == "" || res == null) && (lastname == "")  ) {
      $('.success-message').html("<p>please enter your last name and a valid email address</p>");
    } else if( (firstname == "") && (lastname == "")  ) {
      $('.success-message').html("<p>please enter your first and last name</p>");
